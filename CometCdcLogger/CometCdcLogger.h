...
#ifndef COMET_CDC_LOGGER_H
#define COMET_CDC_LOGGER_H
...
class CometCdcLogger
    : public DAQMW::DaqComponentBase
{
public:
    CometCdcLogger(RTC::Manager* manager);
    virtual ~CometCdcLogger();
